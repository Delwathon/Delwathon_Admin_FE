    ...
    return (
        <>
            <aside
                ...
                aria-label="Sidebar"
            >
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800 custom-scrollbar">
                    <div className="flex items-center mb-4">
                        <img
                            src="assets/delwathon_dark.png"
                            className="w-12 h-12"
                        />
                        <p className="text-2xl uppercase">Delwathon</p>
                    </div>
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a
                                ...
                                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            >
                                <i className="bx bx-bar-chart-alt text-2xl"></i>
                                <span className="flex-1 ml-3 whitespace-nowrap">
                                    Usage
                                </span>
                            </a>
